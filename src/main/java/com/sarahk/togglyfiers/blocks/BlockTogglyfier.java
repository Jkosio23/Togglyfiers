...
public class BlockTogglyfier extends Block
{
    ...
    public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos)
    {
        ...
        if((val.equals(EnumState.ACTIVATED) || val.equals(EnumState.DEACTIVATED)))
        {
            ...
            if(powered) {
            	((TogglyfierListeners)ListenerRegister.GetListeners(worldIn, ModBlocks.togglifyer)).OnActivate(pos);
            }else {
            	((TogglyfierListeners)ListenerRegister.GetListeners(worldIn, ModBlocks.togglifyer)).OnDeactivate(pos);
            }
        }
        TileEntityTogglyfier te = (TileEntityTogglyfier) worldIn.getTileEntity(pos);
